...
#            save_video(
#                [a for a in rgb_gt],
#                path / "video_gt" / f"{scene}_frame_{frame_str}.mp4",
#            )
#
#        # compute scores
#        if self.test_cfg.compute_scores:
...
#        gaussians_prob = self.encoder(batch["context"], self.global_step, False)[0]
#        # gaussians_det = self.encoder(batch["context"], self.global_step, True)[0]
#
